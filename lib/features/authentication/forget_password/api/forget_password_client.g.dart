...
part of 'forget_password_client.dart';
...
class _ForgetPasswordClient implements ForgetPasswordClient {
  _ForgetPasswordClient(this._dio, {this.baseUrl, this.errorLogger});
